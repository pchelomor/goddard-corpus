...
### Issue ISS-012: Terminal Registry/Source Date Drift — L0231–L0235
- **Affected Entries:** `L0231` (*You Can Never Outgrow I AM*), `L0232` (*Your Husband*), `L0233` (*Your Maker*), `L0234` (*Your Supreme Dominion*), `L0235` (*Yours For The Taking*).
- **Description:** The current authoritative registry assigns exact canonical dates `1968-09-23`, `1968-10-18`, `1967-09-16`, `1964-12-15`, and `1970-04-23`, respectively. Their physical reports and `source_manifest.md` files instead agree on exact dates `1969-03-10`, `1968-02-02`, `1969-01-07`, `1953-01-01`, and `1967-09-18`. These are not harmless year-level placeholders; they materially identify different same-title lecture instances or date assignments.
- **Editorial impact (2026-09-03):** All five physical masters were read end-to-end for diagnosis, but no wording is admitted to the curated automatic pool because the physical source objects cannot be safely attributed to the current registry identities/dates.
- **Resolution:** Each receives a diagnostic four-file package with `complete:false`, `blocked:true`, `status: BLOCKED_REGISTRY_SOURCE_DATE_CONFLICT`. Reconcile/rekey registry and physical source identities by corpus_id/date, restore matching canonical objects if needed, then rerun `SOURCE_FIRST_CANONICAL`. Raw source and registry files remain unchanged during editorial review.
